...
d$predictionm4.5 = predictions[,1]
...
# To make a plot comparing model predictions with actual data. Actual data = red, predictions = blue
dens(d$PR, col = "red") 
dens(d$predictionm4.5, col = "blue")

# Create column with model predictions of PR (1s and 0s)
d$Predictionsm4.5[d$predictionm4.5>0.5]=1 
d$Predictionsm4.5[d$predictionm4.5<=0.5]=0
...
#Model predictions
p4.2 <- ggplot(d, aes(Social_Rep, predictionm4.5, color = BotGender, group = BotGender)) +
  geom_point(stat = "summary", fun.y = mean) +
  geom_errorbar(stat = "summary", fun.data = mean_se, width = 0.3, alpha = 0.4) +             
  geom_line(stat = "summary") + 
  ggtitle("Model predictions") + 
